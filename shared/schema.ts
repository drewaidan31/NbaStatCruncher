...
export const nbaPlayers = pgTable("nba_players", {
  ...
  fieldGoalsMade: real("field_goals_made").notNull().default(0),
  ...
  threePointersMade: real("three_pointers_made").notNull().default(0),
  ...
  freeThrowsMade: real("free_throws_made").notNull().default(0),
