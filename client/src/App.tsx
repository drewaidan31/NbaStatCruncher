              ...
              <div className="flex items-center gap-3">
                ...
                <div className="relative">
                  ...
                  >
                    ...
                    {results.length > 0 && (() => {
                      // Extract unique teams from current results
                      const teams: string[] = [];
                      results.forEach((result: any) => {
                        if (result.player.team && !teams.includes(result.player.team)) {
                          teams.push(result.player.team);
                        }
                      });
                      teams.sort();
              ...
              <table className="w-full">
                ...
                <tbody>
                  {results.filter((result: any) => {
                    // Team filter
                    if (selectedTeam !== "all" && result.player.team !== selectedTeam) {
                      return false;
                    }
