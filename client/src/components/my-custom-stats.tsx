...
import { Calculator, Trash2, ChevronDown, ChevronUp } from "lucide-react";
...
export function MyCustomStats({ onStatSelect, isCollapsed = false, setIsCollapsed }: MyCustomStatsProps) {
